...
public class CustomIncomingDialogAudioMessageViewHolder
        extends MessageHolders.IncomingTextMessageViewHolder<DialogMessageNew> {
    ...
    public CustomIncomingDialogAudioMessageViewHolder(View itemView) {
        super(itemView);
    ...
    public void onBind(final DialogMessageNew message) {
        ...
        playPause.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(playPause.getTag().toString().equals(dialogFragment.getString(R.string.pause))) {
                ...
                }else if(playPause.getTag().toString().equals(dialogFragment.getString(R.string.play))) {
